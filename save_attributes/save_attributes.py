...
class SaveAttributes:
    ...
    def initGui(self):
        ...
        icon_path = 'C:/Users/uzaya/AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins/save_attributes/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
    ...
    def run(self):
        ...
        if result:
            ...
            if type_of_layer =="line":
                ...
                eklenecekOznitelikler = ["minDist", "realDist"]
                ...
                if len(lines) > 0:
                    ...
                    for cizgi in lines:
                        ...
                        startingpoint = geom.constGet()[0][0]
                        ...
                        minCizgi = QgsFeature()
                        minCizgi.setGeometry(QgsGeometry.fromPolyline([startingpoint, endpoint]))

                        minMesafe = d.measureLine(minCizgi.geometry().asPolyline())

                        print("minimum distance : ", minDist)

                        cizgi["minDist"] = minDist
                        cizgi["realDist"] = realDist
